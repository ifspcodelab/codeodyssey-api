...
class LoginUserEndpointTest {
    ...
    void setUp(){
        ...
        BDDMockito.when(getTokenService.execute(ArgumentMatchers.any()))
                .thenReturn(loginResponse);
        BDDMockito.when(jwtService.extractAllClaims(ArgumentMatchers.any()))
                .thenReturn(claims);
    }
    ...
    void login_givenLoginRequest_returnsLoginResponse(){
        ...
        Assertions.assertThat(claims.getExpiration())
                .isBefore(DateUtils.addMinutes(new Date(), 16));
