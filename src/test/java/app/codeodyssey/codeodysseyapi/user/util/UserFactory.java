...
public final class UserFactory {
    ...
    public static User createValidUser() {
        return new User("name1", "email1@email.com", "$2a$10$Q8FZ0sHePMBw0fmUBG0xou/mfI3L.lzAKR3ErTIYihxRuj/wbigIm");
    }

    public static User createValidProfessor() {
        var user = new User("name2", "email2@email.com", "$2a$10$Q8FZ0sHePMBw0fmUBG0xou/mfI3L.lzAKR3ErTIYihxRuj/wbigIm");
